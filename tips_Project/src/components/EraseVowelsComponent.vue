...
function eraseVowel (){
	...
	result.value = inputString.value.replace(/[aeiou]/gi, '');
	count.value ++;
}
...
<div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
    <form class="space-y-6" action="#">
        ...
        <h1>You will see vowels disapear.</h1>
        
        <div>
            <label for="word-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Write a sentence here:</label>
            <input id="word-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" 
            v-model="inputString"
            />
        </div>
